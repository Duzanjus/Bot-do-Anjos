...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN: ANJOS BOTS\n'//GANTI NAMA LU COK
            + 'ORG:Criador ANJOS;\n'//GANTI NAMA LU!!
            + 'TEL;type=CELL;type=VOICE;waid=5511932300710:+55 11 93230-0710\n'//GANTI NOMOR LU
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = [
			"5511932300710@s.whatsapp.net"//GANTI NOMOR LU
			]
			premium = [
			"5511932300710@s.whatsapp.net","6283102650464@s.whatsapp.net"//GANTI NOMOR YAG MAU DI PREM, GABISA NYIMPEN DI DATABASE!!
			]
